...
| :--- | :--- | :--- |
| `/apm-1-initiate-setup` | `/apm-1-initiate-planner` | `/apm.initiate` |
| `/apm-2-initiate-manager` | `/apm-2-initiate-manager` | `/apm.manage` |
| `/apm-3-initiate-implementation` | `/apm-3-initiate-worker <id>` | `/apm.execute <id>` |
...
| (none) | `/apm-4-check-tasks` | `/apm.proceed` |
