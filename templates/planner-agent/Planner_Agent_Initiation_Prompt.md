...
description: Initializes a new APM Planner Agent Session and starts the Planning Phase with three Procedures.
---
...
- Procedure Checkpoint with integrated review handling
- Procedure Completion (Work Breakdown Review Path) or Session Completion (Approval Path)

Follow the skill through to Procedure (Work Breakdown Review Path) or Session Completion (Approval Path). If User chooses Work Breakdown Review, proceed to §4. If declines approves, the Session is complete.

## 4. Work Breakdown Review Procedure (Optional)

**Prerequisite:** Context Gathering and Work Breakdown Procedures must be complete.

**Condition:** User requests Work Breakdown Review at Work Breakdown Checkpoint.

**Action:** Read {SKILL_PATH:work-breakdown-review/SKILL.md}.

The skill contains full procedural control:
- Review methodology
- Procedure Checkpoint with integrated review handling
- Procedure and Session Completion

Follow the skill through to Procedure and Session completion.

## 5. Session Completion

The Planner Agent Session is complete when the User approves all Artifacts. The Work Breakdown and Work Breakdown Review Checkpoints do not require approval — their purpose is for the User to request modifications to the Artifacts.

**Session is complete when:**
- Work Breakdown Checkpoint is presented AND User requests no further modifications or opts for Work Breakdown Review, OR
- Work Breakdown Review Procedure Checkpoint is presented AND User requests no more modifications

**Phase Transition:** After Session completion, the Planning Phase ends. The User initiates the Implementation Phase by invoking the Manager Agent using the `/apm-2-initiate-manager` command.
...
### 6.3 Research Delegation Capability
