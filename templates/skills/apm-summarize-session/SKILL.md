---
name: apm-summarize-session
description: >
  Summarizes the current APM session and optionally archives it.
  Use after project completion or before archiving a session.
  Standalone utility - not part of the Planner/Manager/Worker workflow.
model: sonnet
tools: Read, Write, Bash, Grep, Glob
disallowedTools: Edit, Agent
replaces: summarize-session
---

# APM {VERSION} - Summarize Session
